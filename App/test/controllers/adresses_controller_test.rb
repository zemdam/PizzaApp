...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference("Adress.count") do
      post adresses_url, params: { adress: { city: @adress.city, name: @adress.name, street_name: @adress.street_name, street_number: @adress.street_number } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { city: @adress.city, name: @adress.name, street_name: @adress.street_name, street_number: @adress.street_number } }
